...
define('CMSIMPLE_VERSION', 'CMSimple 5.20');
define('CMSIMPLE_RELEASE', 2025071701);
define('CMSIMPLE_DATE', '2025-07-17');
...
foreach (array('download', 'function', 'media', 'search', 'mailform', 'sitemap', 'text', 'selected', 'login', 'logout', 'settings', 'print', 'retrieve', 'file', 'action', 'validate', 'images', 'downloads', 'edit', 'normal', 'stylesheet', 'passwd', 'userfiles', 'cmsimplepages')as $i)
    initvar($i);
