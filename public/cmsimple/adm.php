...
// 4.5
    if ($adm && $fh = fopen($pth['file']['content'], "w")) 
	{
...
// external pagemanager

if ($adm && $f == 'cmsimplepages') 
{
...
if($adm && isset($_GET['pm_data_saved']))
{
	csrfProtection();
...
{
	global $adm, $cf, $tx, $pth, $pm_datafile_path, $pluginloader_tx, $disabled_plugins, $csrfSession;
